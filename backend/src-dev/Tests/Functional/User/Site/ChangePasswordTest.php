...
final class ChangePasswordTest extends ApiWebTestCase
{
    ...
    public static function notValidPasswordDataProvider(): Iterator
    {
        ...
        yield 'Не указан текущий пароль' => [
            [
                'newPassword' => 'newPassword',
                'newPasswordConfirmation' => 'newPassword',
            ],
        ...
        yield 'Не указано подтверждение нового пароля' => [
            [
        ...
        yield 'Новый пароль и его подтверждение не совпадают' => [
            [
                'currentPassword' => 'currentPassword',
        ...
        yield 'Новый пароль не отличается от текущего' => [
            [
                'currentPassword' => 'currentPassword',
