...
final readonly class FunctionalTestsGenerator
{
     ...
     */
    public function generate(string $moduleName, ClassNameDetails $entityClassDetails, array $fields, string $entityTitle): void
    {
        $this->generateSDK($entityClassDetails, $fields);
        $this->generateInfoTest($moduleName, $entityClassDetails, $fields, $entityTitle);
        $this->generateCreateTest($moduleName, $entityClassDetails, $fields, $entityTitle);
        $this->generateRemoveTest($moduleName, $entityClassDetails, $fields, $entityTitle);
        $this->generateUpdateTest($moduleName, $entityClassDetails, $fields, $entityTitle);
        $this->generateListTest($moduleName, $entityClassDetails, $fields, $entityTitle);
     ...
     * @param list<array<string, string>> $fields
     */
    private function generateInfoTest(string $moduleName, ClassNameDetails $entityClassDetails, array $fields, string $entityTitle): void
    {
     ...
     * @param list<array<string, string>> $fields
     */
    private function generateCreateTest(string $moduleName, ClassNameDetails $entityClassDetails, array $fields, string $entityTitle): void
    {
     ...
     * @param list<array<string, string>> $fields
     */
    private function generateRemoveTest(string $moduleName, ClassNameDetails $entityClassDetails, array $fields, string $entityTitle): void
    {
     ...
     * @param list<array<string, string>> $fields
     */
    private function generateUpdateTest(string $moduleName, ClassNameDetails $entityClassDetails, array $fields, string $entityTitle): void
    {
     ...
     * @param list<array<string, string>> $fields
     */
    private function generateListTest(string $moduleName, ClassNameDetails $entityClassDetails, array $fields, string $entityTitle): void
    {
