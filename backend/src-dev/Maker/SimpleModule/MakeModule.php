...
final class MakeModule extends AbstractMaker implements InputAwareMakerInterface
{
    ...
    public function configureCommand(Command $command, InputConfiguration $inputConfig): void
    {
        ...
        $command
            ...
            ->addArgument(
                ...
                mode: InputArgument::REQUIRED,
                description: \sprintf(
                    'Title of Entity (e.g. <fg=yellow>%s</>)',
                    CustomStr::asClassName(CustomStr::getRandomTerm()),
                ),
            )
            ->addArgument(
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator): void
    {
        ...
        $this->crudGenerator->generate(
            namespacePrefix: $moduleName.'\\Http\\Admin\\',
            entityClass: $entityClassDetails,
            repoClassName: $entityClassDetails->getShortName().'Repository',
            fields: $fields,
            entityTitle: $entityTitle,
        );

        $this->functionalTestsGenerator->generate(
